...
//     if (!(cin >> J >> S)) return 0;
//
//     // Guardamos las joyas en el mapa (usamos 100 cubos porque los caracteres son pocos)
//     my_map<char, bool> joyas(100);
//
//     for (char c : J) {
//         joyas[c] = true;
//     }
...
//     long long count = 0;
//
//     // Recorremos S contando cuántas piedras son joyas
//     for (char c : S) {
//         if (joyas.has_key(c)) {
//             count++;
//         }
